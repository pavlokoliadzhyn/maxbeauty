      ...
      >
        ...
        <div className="total">
          ...
          <div className="price">
            ...
            <span className="current">${packageList[packageIndex].price}</span>
          </div>
        </div>
        ...
        <div className="info">
          You agree that ${packageList[packageIndex].price} will be billed every
          month until you cancel according to our{" "}
